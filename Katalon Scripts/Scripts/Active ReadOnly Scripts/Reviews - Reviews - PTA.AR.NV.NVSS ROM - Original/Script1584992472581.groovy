...
WebUI.comment('Reviews>Reviews>PTA/AR/NV/NVSS ROM>Pending ACDC')

'Select Pending ACDC'
WebUI.selectOptionByValue(findTestObject('BITS/PTA-AR-NV-NVSROM/select_ctl00BodyuiStatusDDL'), 'PENDING_ACDC', true)

WebUI.sendKeys(findTestObject('BITS/PTA-AR-NV-NVSROM/select_ctl00BodyuiStatusDDL'), Keys.chord(Keys.ENTER))

WebUI.delay(20)

PendingACDC = WebUI.getText(findTestObject('BITS/NV JR/TotalCount'))

CustomKeywords.'myPack.WriteExcel.demoKey'(PendingACDC, 'Reviews>Reviews>PTA/AR/NV/NVSS ROM>Pending ACDC')

PTANVSSROM_PendingACDC = WebUI.concatenate(((['Reviews>Reviews>PTA/AR/NV/NVSS ROM>Pending ACDC:', PendingACDC]) as String[]))

println(PTANVSSROM_PendingACDC)

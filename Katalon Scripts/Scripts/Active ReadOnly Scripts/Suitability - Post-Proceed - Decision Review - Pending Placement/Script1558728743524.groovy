...
WebUI.comment('Suitability>Post-Proceed>Decision Review>Pending Placement')
...
Loop: for (int row = 0; row < rows_count; row++) {
    ...
    for (int column1 = 0; column1 < columns_count; column1++) {
        ...
        if (celltext == ExpectedResult) {
            ...
            println('Suitability>Post-Proceed>Decision Review>Pending Placement: ' + Columns_row.get(5).getText())

            String DR_PendingPlacement = Columns_row.get(5).getText()

            CustomKeywords.'myPack.WriteExcel.demoKey'(DR_PendingPlacement, 'Suitability>Post-Proceed>Decision Review>Pending Placement')

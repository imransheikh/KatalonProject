...
WebUI.waitForElementVisible(findTestObject('ClemencyRegressionTesting/Support Staff/button_Entry Complete'), 0)

WebUI.click(findTestObject('ClemencyRegressionTesting/Support Staff/button_Entry Complete'))

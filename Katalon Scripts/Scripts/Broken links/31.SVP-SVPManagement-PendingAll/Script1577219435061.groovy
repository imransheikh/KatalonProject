...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/31.SVP-SVPManagement-PendingAll/select_Pending Analysis'), 
    'Pending Analysis', true, 0)

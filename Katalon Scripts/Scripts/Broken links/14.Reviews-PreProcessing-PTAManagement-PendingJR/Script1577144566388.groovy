...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/14.Reviews-PreProcessing-PTAManagement-PendingJR/select_PendingJR'), 
    'Pending JR', true, 0)

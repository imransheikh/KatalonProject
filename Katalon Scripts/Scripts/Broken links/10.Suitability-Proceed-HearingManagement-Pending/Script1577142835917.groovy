...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/10.Suitability-Proceed-HearingManagement-Pending/select_Pending'), 
    'Pending', true, 0)

...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/12.Suitability-PostProceed-CRDocumentMgmtSystem-Select/select_All'), 
    'All', true, 0)

...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/24.MDO-PreProceed-MDOWorkloadManagement-PendingEval/select_Unscheduled'), 
    'Unscheduled', true, 0)

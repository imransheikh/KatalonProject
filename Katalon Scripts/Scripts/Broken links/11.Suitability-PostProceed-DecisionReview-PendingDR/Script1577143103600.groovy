...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/11.Suitability-PostProceed-DecisionReview-PendingDR/select_PendingDR'), 
    'Pending DR', true, 0)

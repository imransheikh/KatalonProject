...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/29.RiskAssess-RiskAssessment-PendingRA/select_PendingReview'), 
    'Pending Review', true, 0)

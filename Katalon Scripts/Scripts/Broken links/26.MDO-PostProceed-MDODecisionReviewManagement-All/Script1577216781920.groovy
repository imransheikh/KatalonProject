...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/26.MDO-PostProceed-MDODecisionReviewManagement-All/select_All'), 
    'All', true, 0)

...
WebUI.navigateToUrl('https://bits-dev4/Bits/SCHEDULING/NOTIFICATIONMANAGEMENT.ASPX')

not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/9.Suitability-PreProceed-AlertManagement-All/select_All'), 
    'All', true, 0)

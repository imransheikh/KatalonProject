...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/18.Reviews-PreProcessing-ARScreeningManagement-Pending/select_Pending'), 
    'Pending', true, 0)

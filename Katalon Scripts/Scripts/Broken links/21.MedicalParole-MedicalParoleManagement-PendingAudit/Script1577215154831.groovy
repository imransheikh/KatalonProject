...
not_run: VerifyOptionSelected = WebUI.verifyOptionSelectedByLabel(findTestObject('BrokenLinks/21.MedicalParole-MedicalParoleManagement-PendingAudit/select_PendingAudit'), 
    'Pending Audit', true, 0)

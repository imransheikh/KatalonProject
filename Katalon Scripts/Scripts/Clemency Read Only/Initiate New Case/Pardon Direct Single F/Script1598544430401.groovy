...
'Received Date'
WebUI.setText(findTestObject('Clemency Read Only/Initiate/Pardon Direct Single F/Page_/input_Source_receivedDate'), CDATE)
...
WebUI.setText(findTestObject('Clemency Read Only/Initiate/Pardon Direct Single F/Page_/input_Addresses_mat-input-19'), '100 Waiola St.')

WebUI.setText(findTestObject('Clemency Read Only/Initiate/Pardon Direct Single F/Page_/input_Residence Address_mat-input-20'), 'Honolulu')

WebUI.setText(findTestObject('Clemency Read Only/Initiate/Pardon Direct Single F/Page_/input_City_mat-input-21'), 'HI')

WebUI.setText(findTestObject('Clemency Read Only/Initiate/Pardon Direct Single F/Page_/input_Country_mat-input-22'), '98554')

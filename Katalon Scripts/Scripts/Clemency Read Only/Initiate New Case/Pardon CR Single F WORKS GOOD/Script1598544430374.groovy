...
'Type First Name.'
WebUI.setText(findTestObject('ClemencyRegressionTesting/Support Staff/input_Personal Details_first-name'), 'Katalon')
...
'Enter \'DOB\'.'
WebUI.setText(findTestObject('ClemencyRegressionTesting/Support Staff/input_DOB'), '2/5/1999')

'Enter SSN.'
WebUI.setText(findTestObject('ClemencyRegressionTesting/Support Staff/input_SSN'), '987654321')
...
'Enter CDCR#'
WebUI.setText(findTestObject('ClemencyRegressionTesting/Support Staff/input_Identifiers_mat-input-1'), 'BH6732')
...
WebUI.click(findTestObject('ClemencyRegressionTesting/Support Staff/div_Zip Code_mat-checkbox-inner-container'))
...
'Enter \'Email\'.'
WebUI.setText(findTestObject('ClemencyRegressionTesting/Support Staff/input_email'), 'victor.mmm223.gtrt@ggmail.com')
...
WebUI.verifyElementPresent(findTestObject('ClemencyRegressionTesting/Support Staff/div_JudgeNotLegible'), 2)

WebUI.delay(3)

/* Uncheck expedite */
'Validate \'Date Signed by Applicant\' is cleared and disabled if user checks \'Date Not Available\'.'
WebUI.comment('Validate \'Date Signed by Applicant\' is cleared and disabled if user checks \'Date Not Available\'.')

'Check \'Date Not Available\'.'
WebUI.click(findTestObject('ClemencyRegressionTesting/Support Staff/div_DateNotAvailable_mat-checkbox-inner-container'))

'Validate "Judge" First Name and Last name are cleared and disabled is user checks \'Not Legible\'.'
WebUI.comment('Validate "Judge" First Name and Last name are cleared and disabled is user checks \'Not Legible\'.')

not_run: WebUI.click(findTestObject('ClemencyRegressionTesting/Support Staff/button_Save'))
